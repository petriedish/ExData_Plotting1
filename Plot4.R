...
png(file="Plot4.png")
	...
	#Plot1
	plot(df1$Date, df1$Global_active_power, type = "n", ylab = "Global Active Power", xlab = "")
	lines(df1$Date, df1$Global_active_power)
	
	#Plot2
	plot(df1$Date, df1$Voltage, type = "n", ylab = "Voltage", xlab = "datetime")
	lines(df1$Date, df1$Voltage)
	...
	#Plot4
	plot(df1$Date, df1$Global_reactive_power, type = "n", ylab = "Global_reactive_power", xlab = "datetime")
	lines(df1$Date, df1$Global_reactive_power)
